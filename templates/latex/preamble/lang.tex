% eg.: en
{% set first_lang = info.translation.language %}
{% set sec_langs = info.translation.other_languages %}

% eg.: th jp
% {% for lang in sec_langs %}
% {{ lang }}
% {% endfor %}

% % TODO
% % document installation of texlive-langextra arch pack
...
{% if first_lang == "en"  %}
    {% include "latex/preamble/lang/en.tex" %}
{% elif first_lang == "pt-BR"  %}
    {% include "latex/preamble/lang/pt-BR.tex" %}
{% else  %}
    \TODOLangElse
{% endif %}
